...
const TCHAR CPluginTest::PNAME_RANGE[] = _T("range");
const TCHAR CPluginTest::PNAME_RESOLUTION[] = _T("resolution");
const TCHAR CPluginTest::PNAME_PATTERN[] = _T("pattern");
const TCHAR CPluginTest::PNAME_LOOP[] = _T("loop");
